...
public class RepairActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        finishBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!scannedList.isEmpty()) {
                    ...
                    builder.setMessage("Are you sure you want to submit repair info?");
                    ...
                    Toast.makeText(RepairActivity.this, "Error: Asset List is Empty", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public void onClick(View v) {
                if (!scannedList.isEmpty()) {
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            finish();
                            startActivity(new Intent(RepairActivity.this, WelcomeActivity.class));
                        }
                    });
                    builder.setNegativeButton("No", null);
                    builder.show();
    ...
    private void performExcelLookup() {
        ...
        progressDialog.setMessage("Sending Repair Data...");
    ...
    private class ReadDataFromSheetTask extends AsyncTask<Void, Void, List<List<Object>>> {
        ...
        protected void onPostExecute(List<List<Object>> values) {
            ...
            if (values != null) {
                ...
                Toast.makeText(RepairActivity.this, "Error. Check network connection and try refreshing login", Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void sendInfo() {
        ...
        new RepairActivity.SendInfoTask().execute();
    }
    ...
    private class SendInfoTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                ...
                finish();
                startActivity(new Intent(RepairActivity.this, FinishActivityRep.class));
            } else {
